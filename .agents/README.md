...
2. Leia este arquivo.
3. Carregue somente as skills relevantes em `.agents/skills/<skill>/SKILL.md`.
4. Consulte a documentacao aplicavel em `docs/`.
5. Trabalhe a partir dos arquivos versionados do repositorio, nunca apenas da memoria conversacional.
...
ETAPAS de refatoracao devem preservar comportamento. ETAPAS de limpeza de legado devem provar ausencia de uso por busca, teste ou evidencia equivalente. ETAPAS de congelamento devem registrar decisoes congeladas, decisoes pendentes e regras de nao regressao.
