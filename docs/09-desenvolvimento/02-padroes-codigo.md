...
O repositório já exibe padrões claros de organização, ainda que nem todos estejam formalizados em um guia separado. Os padrões mais consistentes aparecem na separação de responsabilidades e no uso de componentes com propósito definido.
...
- serviços com responsabilidade única (`SdGwLinkSupervisor`, `SdGwLinkEngine`);
