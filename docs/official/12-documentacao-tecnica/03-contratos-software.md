...
Os contratos históricos em `docs/legacy/` continuam úteis como referência de framing e semântica básica do SDGW, mas não devem prevalecer sobre a documentação oficial vigente quando houver divergência.
