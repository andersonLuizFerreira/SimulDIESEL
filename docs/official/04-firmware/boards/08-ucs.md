...
Board identificada como UCS. Descrição funcional oficial ainda pendente.
...
- O identificador SDH UCS está reservado na arquitetura.
- Os resources e exemplos devem ser preenchidos quando a função da board estiver formalizada.
