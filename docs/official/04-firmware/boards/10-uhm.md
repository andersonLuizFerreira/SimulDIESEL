...
Board ou entidade lógica identificada como UHM. Descrição funcional oficial ainda pendente.
...
- O identificador UHM aparece na arquitetura geral do projeto.
- Os recursos, papéis e exemplos de comandos devem ser consolidados oficialmente.
