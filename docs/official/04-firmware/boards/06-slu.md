...
Board identificada como SLU. Descrição funcional oficial ainda pendente.
...
- O identificador SDH SLU está reservado na arquitetura.
- Os recursos internos e exemplos de comando devem ser consolidados quando o contrato da board for fechado.
