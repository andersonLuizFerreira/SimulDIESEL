...
Em `GwProtocol.cs`, o contrato vivo da GSA está materializado em constantes:
...
- ele é o contrato que a BLL GSA realmente recebe em `OnFrameReceived(...)` e `OnEventReceived(...)`.
