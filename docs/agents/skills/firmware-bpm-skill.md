...
Use para gateway BPM, endpoints Serial/Bluetooth, SDGW embarcado, roteamento para I2C/SPI, DeviceTable e eventos de boards.
...
- Quebrar evento assíncrono de board.
