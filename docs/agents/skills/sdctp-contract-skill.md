# Skill: SDCTP Contract

## Quando usar

Use para massa CAN RX/TX, mirror table, `CanRxOutputBuffer`, compactacao `DATA_MASK`, eventos `CAN_CREATE/EDIT/DELETE/TIC/ROW` e wrappers `Sdctp*`.
...
- `hardware/firmware/UCE .../lib/services/can/sdctp/`
- dumps SDCTP.
