...
Use para Banco de Modulos, schemas SQLite/PostgreSQL, perfis de modulos, pinagem, sinais, comandos SDH, sequencias de teste e capturas. Use tambem para DAL de banco, repositories e BLL de inicializacao do banco local.
