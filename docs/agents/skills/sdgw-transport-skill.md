# Skill: SDGW Transport

## Quando usar

Use para gateway/transporte, framing, COBS, CRC, ACK/ERR, sequencia, retry, timeout, endpoints Serial/Bluetooth, BPM gateway e roteamento fisico.
