...
Orientar ETAPAS do Banco de Modulos, schemas, perfis, pinagem, sinais, comandos SDH, sequencias de teste e capturas.

## Quando usar

Use para `Data/Modules/`, schemas SQLite/PostgreSQL, relacao com SDH, dumps e validadores do modelo.
