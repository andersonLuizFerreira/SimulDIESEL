...
Orientar ETAPAS do firmware UCE, SPI slave, LedService, CanService, SDCTP embarcado, driver CAN e execucao fisica.

## Quando usar

Use para firmware da UCE, servicos CAN/LED, SPI, IRQ, tabelas RX/TX, driver CAN e contratos TLV da UCE.
...
- [ ] Build host/BPM apenas se a ETAPA tocar contrato ponta a ponta.
