...
O SimulDIESEL consiste em uma plataforma de bancada destinada à manutenção, diagnóstico, análise, simulação e validação de centrais e módulos automotivos da linha DIESEL, com foco em caminhões, máquinas agrícolas e equipamentos pesados.
...
SimulDIESEL is a bench platform designed for maintenance, diagnostics, analysis, simulation, and validation of DIESEL automotive control units and electronic modules, focused on trucks, agricultural machines, and heavy equipment.
...
SimulDIESEL es una plataforma de banco destinada al mantenimiento, diagnóstico, análisis, simulación y validación de centrales y módulos automotrices de la línea DIESEL, enfocada en camiones, maquinaria agrícola y equipos pesados.
...
SimulDIESEL ist eine Prüfstandsplattform für Wartung, Diagnose, Analyse, Simulation und Validierung von Steuergeräten und elektronischen Modulen im DIESEL-Bereich mit Fokus auf Lastkraftwagen, landwirtschaftliche Maschinen und schwere Geräte.
