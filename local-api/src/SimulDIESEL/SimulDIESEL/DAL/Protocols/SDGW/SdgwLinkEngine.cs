...
{
    /// <summary>
    /// Infraestrutura técnica do protocolo SDGW.
    /// Responsável por framing, ACK/timeout/retry e entrega de frames de aplicação.
    /// Não deve concentrar semântica de board.
    /// </summary>
